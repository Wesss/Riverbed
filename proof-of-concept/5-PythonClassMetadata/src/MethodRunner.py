...
class lib_MethodRunner:
    _hx_class_name = "lib.MethodRunner"
    __slots__ = ()
    _hx_methods = ["runMethod"]

    def __init__(self):
        pass

    def runMethod(self,objectWithMetadata):
        metadata = Reflect.field(objectWithMetadata,"getFunctions")()
        streamMethod = (metadata[0] if 0 < len(metadata) else None)
        print(str(Std._hx_is(lib_domain_VoidDomain.instance,streamMethod.parameter)))
        print(str(Reflect.isFunction(streamMethod.method)))
        streamMethod.method(lib_domain_VoidDomain.instance)



class lib_domain_Domain:
    _hx_class_name = "lib.domain.Domain"
    __slots__ = ()
...
class lib_domain_VoidDomain(lib_domain_Domain):
    _hx_class_name = "lib.domain.VoidDomain"
    __slots__ = ()
    _hx_fields = []
    _hx_methods = []
    _hx_statics = ["instance"]
    _hx_interfaces = []
    _hx_super = lib_domain_Domain
...
lib_domain_VoidDomain.instance = lib_domain_VoidDomain()
